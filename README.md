...
``` XML
compile group: 'ws.schild', name: 'jave-all-deps', version: '3.4.0-SNAPSHOT'
```

### For one platform only (Linux 64Bit in this case)
``` XML
compile group: 'ws.schild', name: 'jave-core', version: '3.4.0-SNAPSHOT'
compile group: 'ws.schild', name: 'jave-nativebin-linux64', version: '3.4.0-SNAPSHOT'
```
