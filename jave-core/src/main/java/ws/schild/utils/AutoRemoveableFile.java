...
/**
 * Use this class in a try-with-resources block to automatically delete the referenced
 * file when this goes out of scope.
 * @author mressler
 *
 */
public class AutoRemoveableFile extends File implements AutoCloseable {
	...
	public void close() {
		...
		if (!closed) {
			logger.warn("File " + getAbsolutePath() + " did not automatically delete itself: " +
