...
/**
 * A VideoProgressListener is meant to share progress from potentially
 * any number of EncoderProgressListeners. Because it would be hard to
 * determine the overall status by just tracking successive progress
 * from ffmpeg, an onBbegin and onComplete have been added.
 * @author mressler
 *
 */
