...
public class VideoDrawtext implements VideoFilter {
   ...
   *
   * <p>Bottom right x=w-tw:y=h-th Bottom right with 10 pixel padding x=w-tw-10:y=h-th-10 Top right
   * x=w-tw Top right with 10 pixel padding x=w-tw-10:y=10 Top left x=0:y=0 Top left with 10 pixel
   * padding x=10:y=10 Bottom left y=h-th Bottom left with 10 pixel padding x=10:h-th-10 centered
   * x=(w-text_w)/2:y=(h-text_h)/2
   *
   * <p>Can be used to speicfy other positions like "x=(w-text_w)/2:y=(h-text_h)/2" for centered
   * text water mark
   *
